...
**Technology stack:** Next.js & GraphQL

## Objective

Develop a responsive Next.js/TypeScript web application that allows users to explore games using the provided GraphQL API. The solution must meet functional, technical, and accessibility standards, and be optimized for usability and performance.
...
- Framework: Latest version of Next.js (using App Router structure)
- Language: TypeScript
...
**When** the data is fetched from the GraphQL API  
...
- Query to fetch games from 2015 to 2017
- Query to fetch specific game details by game ID
