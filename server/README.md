...
Backend API for technical assignments.

## 🚀 Quick Start

Ensure Docker and Docker Compose are installed and running - Also ensure no other services are running on ports `8000` and `5432`.
...
You can stop here if you want. The rest are you details for your reference. 🙂
